            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="創造性">創造性</option>
                    <option value="生産性">生産性</option>
                    <option value="脳科学">脳科学</option>
                    <option value="記憶術">記憶術</option>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 text-gray-900 cursor-text"
                  placeholder="タグをカンマ区切りで入力（例：思考法, 整理術, 創造性）"
                />
              ...
              {/* Recommended By */}
              <div>
                <label htmlFor="recommended_by" className="block text-sm font-medium text-gray-700 mb-2">
                  推薦者
                </label>
                <input
                  type="text"
