    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 mb-8">
            <div className="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="flex-shrink-0">
                <div className="w-48 h-64 bg-gradient-to-br from-primary-100 to-primary-200 rounded-xl flex items-center justify-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl text-gray-600 mb-4">{memoDetailData.bookAuthor}</p>
          ...
          {/* Memo Content */}
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">メモ</h3>
            
            {/* 読んだこと */}
            <div className="mb-8">
              <h4 className="text-xl font-semibold text-gray-800 mb-4">3.1. 読んだこと</h4>
